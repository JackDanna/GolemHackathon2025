...
class Fields:
    ...
    def from_list(cls, entries: List[Tuple[str, bytes]]) -> Self:
        ...
        Raises: `my_component.types.Err(my_component.imports.types.HeaderError)`
        """
        raise NotImplementedError
...
class IncomingBody:
    ...
    def stream(self) -> streams.InputStream:
        ...
        Raises: `my_component.types.Err(None)`
        """
        raise NotImplementedError
    @classmethod
...
class OutgoingBody:
    ...
    def finish(cls, this: Self, trailers: Optional[Fields]) -> None:
        ...
        Raises: `my_component.types.Err(my_component.imports.types.ErrorCode)`
        """
        raise NotImplementedError
    def __enter__(self) -> Self:
        """Returns self"""
